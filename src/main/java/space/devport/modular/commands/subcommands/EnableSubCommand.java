...
public class EnableSubCommand extends ModularSubCommand {

    public EnableSubCommand(DevportModular modular) {
        super("enable", modular);
    }
    ...
    protected CommandResult perform(CommandSender sender, String label, String[] args) {
        ...
        module.enable();
        language.getPrefixed("Commands.Enable.Done")
